export const planData = {
    // Adicionado type: 'room' aos ambientes
    rooms: [
        { 
        ...
        { 
            ...
            images: ['assets/images/banheiro_social_lado_2.jpg'] 
        },
        { 
        ...
        { 
            ...
            images: ['assets/images/quintal.jpg', 'assets/images/beco_do_quintal.jpg'] 
        }
    ],
    // Passagens renomeadas e com metadados
    passages: [
        { id: 'p1', type: 'passage', name: 'Entryway (Sala/Coz)', size: '0.80m', color: '#cbd5e1', x: 485, y: 444, w: 80, h: 15 },
        { id: 'p2', type: 'passage', name: 'Entryway (Coz/Corredor)', size: '0.80m', color: '#cbd5e1', x: 485, y: 849, w: 80, h: 15 },
    ],
    // Portas mapeadas e com nomes lógicos
    doors: [
        { id: 'd1', type: 'door', name: 'Porta de Entrada', size: '0.75m', color: '#94a3b8', gap: { x: 470, y: 217, w: 15, h: 75 }, leaf: { x1: 485, y1: 217, x2: 560, y2: 217 }, arc: 'M 560 217 A 75 75 0 0 1 485 292' },
        { id: 'd2', type: 'door', name: 'Porta (Quarto 1)', size: '0.80m', color: '#94a3b8', gap: { x: 470, y: 725, w: 15, h: 80 }, leaf: { x1: 470, y1: 805, x2: 390, y2: 805 }, arc: 'M 390 805 A 80 80 0 0 1 470 725' },
        // Porta Q2: Recuo de 278cm do fundo (y:1134), resultando em início em y:786
        { id: 'd3', type: 'door', name: 'Porta (Quarto 2)', size: '0.80m', color: '#94a3b8', gap: { x: 470, y: 865, w: 15, h: 80 }, leaf: { x1: 470, y1: 865, x2: 390, y2: 865 }, arc: 'M 390 865 A 80 80 0 0 0 470 945' },
        // Porta Banheiro Soc: Recuo de 263cm do fundo (y:1119), resultando em início em y:786
        { id: 'd4', type: 'door', name: 'Porta (Banheiro Social)', size: '0.70m', color: '#94a3b8', gap: { x: 650, y: 865, w: 15, h: 70 }, leaf: { x1: 665, y1: 866, x2: 735, y2: 866 }, arc: 'M 735 866 A 70 70 0 0 1 665 936' },
        // Porta Q3: Agora abrindo para dentro
        { 
            id: 'd5', 
            type: 'gate', 
            name: 'Portão Quintal / Corredor', 
            size: '0.80m', 
            color: '#64748b', 
            gap: { x: 485, y: 1119, w: 80, h: 15 }, 
            // Folha agora aponta para cima (dentro do corredor)
            leaf: { x1: 485, y1: 1119, x2: 485, y2: 1039 }, 
            // Arco invertido para mostrar a abertura interna
            arc: 'M 485 1039 A 80 80 0 0 1 565 1119' 
        },
        { 
            id: 'd6', 
            type: 'door', 
            ...
            size: '0.70m', 
            color: '#94a3b8', 
            gap: { x: 470, y: 1292, w: 70, h: 15 }, 
            leaf: { x1: 470, y1: 1307, x2: 470, y2: 1377 }, 
            arc: 'M 470 1377 A 70 70 0 0 0 540 1307' 
        },
        { id: 'd9', type: 'gate', name: 'Portão Social Frontal', size: '0.88m', color: '#64748b', gap: { x: 15, y: 132, w: 80, h: 15 }, leaf: { x1: 15, y1: 147, x2: 15, y2: 235 }, arc: 'M 15 235 A 90 90 0 0 0 95 147' }
    ],
    // Janelas mapeadas
    windows: [
        { id: 'w1', type: 'gate', name: 'Portão da Garagem', size: '2.65m', color: '#64748b', x: 155, y: 0, w: 265, h: 15 },
        { id: 'w3', type: 'window', name: 'Janela (Sala)', size: '1.00m', color: '#bae6fd', x: 575, y: 132, w: 100, h: 15 },
        { id: 'w6', type: 'window', name: 'Janela (Quarto 2)', size: '0.58m', color: '#bae6fd', x: 95, y: 930, w: 15, h: 58 },
        { id: 'w8', type: 'window', name: 'Janela (Banheiro Q2)', size: '0.40m', color: '#bae6fd', x: 140, y: 1359, w: 40, h: 15 },
        { id: 'w10', type: 'window', name: 'Janela (Quarto 3)', size: '0.80m', color: '#bae6fd', x: 455, y: 1380, w: 15, h: 80 },
        // Nova Janela Banheiro Social: 30cm da direita para esquerda na parede do jardim
        { id: 'w11', type: 'window', name: 'Janela (Banheiro Social)', size: '0.40m', color: '#bae6fd', x: 695, y: 1119, w: 40, h: 15 },
        { id: 'w12', type: 'window', name: 'Janela (Quarto 1)', size: '1.00m', color: '#bae6fd', x: 240, y: 507, w: 100, h: 15 },
    ],
    walls: [
    ...
    passages: [
        { id: 'p3', type: 'passage', name: 'Vazado / Muro Frontal', size: '2.48m', color: '#cbd5e1', x: 170, y: 132, w: 248, h: 15 },
        { id: 'p1', type: 'passage', name: 'Entryway (Sala/Coz)', size: '0.80m', color: '#cbd5e1', x: 485, y: 444, w: 80, h: 15 },
        { id: 'p2', type: 'passage', name: 'Entryway (Coz/Corredor)', size: '0.80m', color: '#cbd5e1', x: 485, y: 849, w: 80, h: 15 },
        { id: 'p4', type: 'passage', name: 'Entryway (Banheiro Q2)', size: '0.90m', color: '#cbd5e1', x: 115, y: 1119, w: 90, h: 15 },
        { id: 'p5', type: 'passage', name: 'Entryway (Banheiro Q3)', size: '0.68m', color: '#cbd5e1', x: 650, y: 1339, w: 15, h: 68 },
    ],
};